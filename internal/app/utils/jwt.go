...
// ParseToken 解析 token
func (j *JWT) ParseTokenWithNoAuth(tokenString string) (*CustomClaims, error) {
	token, _ := jwt.ParseWithClaims(tokenString, &CustomClaims{}, func(token *jwt.Token) (i interface{}, e error) {
		return j.SigningKey, nil
	})
	if token != nil {
