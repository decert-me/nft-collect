...
type Contract struct {
	global.MODEL
	Chain               string `gorm:"index:chain_address,unique" json:"chain" form:"chain"`                        // 区块链的简称（eth, bnb, polygon, moonbeam, arbitrum, optimism, platon, avalanche, cronos）
	ContractAddress     string `gorm:"index:chain_address,unique"  json:"contract_address" form:"contract_address"` // 合约地址
	ContractName        string `gorm:"default:''" json:"contract_name" form:"contract_name"`                        // 合约名称
